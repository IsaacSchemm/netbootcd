...
if [ ! -f CorePlus-$COREVER.iso ];then
	wget http://www.tinycorelinux.net/9.x/x86/release/CorePlus-$COREVER.iso
fi
...
echo "if ! which startx;then netboot;fi;echo \*\* Type \"netboot\" and press enter to launch the NetbootCD main menu. \*\*" >> ${NBINIT}/etc/skel/.profile
